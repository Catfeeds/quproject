<?php $this->load->view('cead/header')?>
			...
			<div class="row-fluid">
				<div class="well span5 center login-box">
					...
					<form class="form-horizontal" action="cead/login" method="post">
						...
						<table width="100%">
							<tr>
								...
								<div class="input-prepend" title="Username" data-rel="tooltip">
									<span class="add-on"><i class="icon-user"></i></span><input autofocus class="input-large span10" name="username" id="username" type="text" value="<?php echo isset($data['loginname']) ? $data['loginname'] : '';?>" /><span style="color:red"><?php echo isset($error['loginname']) ? $error['loginname'] : '';?></span>
								</td>
							</tr>
							<tr>
								<td width="55px">密码: </td>
